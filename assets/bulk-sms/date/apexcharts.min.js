	...
	var w, k, A = {
			...
			return a(t, [{
				...
				value: function(t) {
					...
					this.ctx.getSyncedCharts().forEach((function(t) {
						var i = t.w;
						i.globals.lastXAxis.min = void 0, i.globals.lastXAxis.max = void 0, t.updateHelpers.revertDefaultAxisMinMax(), "function" == typeof i.config.chart.events.zoomed && e.zoomCallback({
				...
				value: function(t) {
					...
					if (this.clientY = l, this.clientX = o, r.globals.capturedSeriesIndex = -1, r.globals.capturedDataPointIndex = -1, l < n.top || l > n.top + n.height) this.handleMouseOut(s);
						...
						if (r.globals.isBarHorizontal && this.tooltipUtil.hasBars() && (g = !1), "mousemove" === a.type || "touchmove" === a.type || "mouseup" === a.type) {
							if (null !== d && d.classList.add("apexcharts-active"), null !== this.ycrosshairs && this.blyaxisTooltip && this.ycrosshairs.classList.add("apexcharts-active"), g && !this.showOnIntersect) this.handleStickyTooltip(a, o, l, s);
		...
		At = function() {
			...
			return a(t, [{
				...
				key: "drawPolygons",
				value: function(t) {
					for (var e = this, i = this.w, a = t.parent, s = new ot(this.ctx), r = i.globals.yAxisScale[0].result.reverse(), n = r.length, o = [], l = this.size / (n - 1), h = 0; h < n; h++) o[h] = l * h;
					o.reverse();
					var c = [],
						d = [];
				...
				value: function(t, e) {
					...
					if (s.comboCharts) {
						...
						case "area":
							...
							break;
						case "bar":
							if (a.chart.stacked) b = new yt(this.ctx, e).draw(s.series);
							else b = new E(this.ctx, e).draw(s.series);
							break;
						case "candlestick":
							b = new wt(this.ctx, e).draw(s.series);
							break;
						case "rangeBar":
							b = p.draw(s.series);
							break;
						case "heatmap":
							b = new kt(this.ctx, e).draw(s.series);
							break;
						case "pie":
						case "donut":
						case "polarArea":
		...
		zt = function() {
			...
			return a(i, [{
				...
				value: function(t, e) {
					...
					i.globals.axisCharts ? a = i.globals.dom.Paper.select("".concat(s, " path[j='").concat(e, "'], ").concat(s, " circle[j='").concat(e, "'], ").concat(s, " rect[j='").concat(e, "']")).members[0] : void 0 === e && (a = i.globals.dom.Paper.select("".concat(s, " path[j='").concat(t, "']")).members[0], ("pie" === i.config.chart.type || "polarArea" === i.config.chart.type || "donut" === i.config.chart.type) && new lt(this.ctx).pieClicked(t));
